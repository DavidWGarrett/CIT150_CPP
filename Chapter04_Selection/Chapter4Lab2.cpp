...
int main()
{
	...
	int dailyRate = 0; // Initialized to 0 so calculations can be performed below line 50
	string nameOfDog;
	const int RATE_SMALL_DOG = 12, RATE_MEDIUM_DOG = 15, RATE_BIG_DOG = 19;
	const int DISCOUNT_MEDIUM_DOG = 3, DISCOUNT_OTHER_SIZE_DOG = 2;
	const int WEIGHT_SMALL_DOG = 10, WEIGHT_BIG_DOG = 25;
	...
	{
		dailyRate -= (WEIGHT_SMALL_DOG < sizeOfDog && sizeOfDog <= WEIGHT_BIG_DOG) ?
